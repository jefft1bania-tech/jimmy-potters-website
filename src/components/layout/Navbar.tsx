      ...
      <div className="section-container">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-1">
            ...
            {/* Admin shortcut — only visible when signed in as admin */}
            {member?.role === 'admin' && (
              <Link
                href="/admin"
                className={`flex flex-col items-center gap-0.5 px-1.5 py-1 rounded-lg transition-colors ${isDarkNav ? 'text-black hover:bg-black/10 ring-1 ring-black/30' : 'text-black hover:bg-stone-100/50 ring-1 ring-black/20'}`}
              ...
              >
                ...
                <span className="text-[10px] md:text-xs font-body font-bold leading-none">Admin</span>
              </Link>
            )}
