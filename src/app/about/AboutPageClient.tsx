        ...
        <div className="section-container py-16 md:py-20">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <section className="bg-white rounded-2xl shadow-sm p-8 md:p-12 border border-stone-100">
              ...
              <p className="text-stone-600 font-body leading-relaxed mb-4 text-[15px]">
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-stone-100 text-center">
                ...
                <h3 className="font-heading font-bold text-base text-stone-900 mb-2">Kiln-Fired</h3>
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-stone-100 text-center">
                ...
                <h3 className="font-heading font-bold text-base text-stone-900 mb-2">Handmade</h3>
                <p className="text-stone-500 font-body text-sm leading-relaxed">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-stone-100 text-center">
                ...
                <h3 className="font-heading font-bold text-base text-stone-900 mb-2">Ships Safely</h3>
                <p className="text-stone-500 font-body text-sm leading-relaxed">
            ...
            <section className="bg-white rounded-2xl shadow-sm overflow-hidden border border-stone-100">
              ...
              <div className="p-8 md:p-12 text-center -mt-8 relative">
                <h2 className="font-heading font-bold text-2xl text-stone-900 mb-2">
                  {t.aboutPage.contactTitle}
                </h2>
                <p className="text-stone-500 font-body mb-6 text-sm">
                  {t.aboutPage.contactSubtitle}
                </p>

                {/* Contact grid */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-md mx-auto text-sm font-body">
                  <a href="mailto:jimmy@jimmypotters.com" className="flex items-center gap-2.5 p-3 rounded-xl bg-stone-50 hover:bg-[#C9A96E]/10 transition-colors text-stone-700 hover:text-stone-900">
                  ...
                  <a href="tel:+17038621300" className="flex items-center gap-2.5 p-3 rounded-xl bg-stone-50 hover:bg-[#C9A96E]/10 transition-colors text-stone-700 hover:text-stone-900">
                    <svg className="w-4 h-4 text-[#C9A96E] flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                    (703) 862-1300
                  </a>
                  <a href="https://instagram.com/jimmypottersvirtualclayclass" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 p-3 rounded-xl bg-stone-50 hover:bg-[#C9A96E]/10 transition-colors text-stone-700 hover:text-stone-900">
                  ...
                  <a href="https://facebook.com/Jpsfairfax" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 p-3 rounded-xl bg-stone-50 hover:bg-[#C9A96E]/10 transition-colors text-stone-700 hover:text-stone-900">
                    <svg className="w-4 h-4 text-[#C9A96E] flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-6 flex items-center justify-center gap-3 text-stone-400 text-xs font-body">
                ...
                <div className="mt-8 flex flex-col sm:flex-row justify-center gap-3">
                  ...
                  <Link href="/shop/gallery" className="inline-flex items-center justify-center gap-2 border border-stone-300 text-stone-600 hover:border-stone-400 hover:text-stone-800 font-body font-semibold py-3 px-6 rounded-xl transition-all duration-200 text-sm">
                    View Gallery
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-3.5 h-3.5">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                    </svg>
